...
public class GameUserDB {
    ...
    static{
        gameUserInfos.put(1, new GameUserInfo(1, "Lokesh", "Gupta", "lokesh.gupta@example.com"));
        gameUserInfos.put(2, new GameUserInfo(2, "John", "Gruber", "john.gruber@example.com"));
        gameUserInfos.put(3, new GameUserInfo(3, "Melcum", "Marshal", "melcum.marshal@example.com"));
    }
